    ...
    if score_1 < SCORE_MAX and score_2 < SCORE_MAX:
        ...
        if ball_x < 100:
            if player_1_y < ball_y + 25 < player_1_y + 150:
                # Check if ball hits the middle of the paddle
                if player_1_y + 75 - 10 < ball_y < player_1_y + 75 + 10:
                    increase_ball_speed()
                ball_dx *= -1
                ball_dy *= -1
                bounce_sound_effect.play()
        ...
        if ball_x > 1160:
            if player_2_y < ball_y + 25 < player_2_y + 150:
                # Check if ball hits the middle of the paddle
                if player_2_y + 75 - 10 < ball_y < player_2_y + 75 + 10:
                    increase_ball_speed()
                ball_dx *= -1
                ball_dy *= -1
                bounce_sound_effect.play()
        ...
        player_2_movement = 5
        error_margin = random.randint(-30,30)
